...
from webserver.common.users.level import HLUser_Level
...
class HLUser(HLUser_Papers, HLUser_Books, HLUser_Team, HLUser_Job, HLUser_Observables, HLUser_Level):
	"""
