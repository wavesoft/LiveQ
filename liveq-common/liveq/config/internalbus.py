...
class InternalBusConfig:
	...
	def fromConfig(config):
		...
		# Populate classes
		StoreConfig.IBUS_CLASS = config.get("internal-bus", "class")
		StoreConfig.IBUS_CONFIG = BusConfigClass.fromClass( StoreConfig.IBUS_CLASS, config._sections["internal-bus"] )
