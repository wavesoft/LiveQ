...
define(
	...
	function(THREE, THREEx, Animator, R, C, Fluctuation, FluctuationSprite, FeymanDiagram, FractalScene ) {
		...
		/**
		 * Auto-generated scene based on a configuration provided
		 */
		...
		var Exp3DScreen = function( container ) {
			...
			// ============================
			//  Drop some parameters for debugging
			// ============================
			var p1 = $('<div class="parameter"><h1>B1</h1><div class="title">This is the B1 parameter</div></div>');
			p1.css({left: 50, top: 50});
			this.hostDOM.append(p1);
