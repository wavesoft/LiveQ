 ...
 */
LiveQ.Calculate.chi2Bins = function(histoTheory, histoData, uncertainty) {
 ...
 */
LiveQ.Calculate.chi2 = function(histoTheory, histoData, uncertainty) {
	var perBin = LiveQ.Calculate.chi2Bins(histoTheory, histoData, uncertainty),
		avg = 0;
 ...
 */
LiveQ.Calculate.chi2WithError = function(histoTheory, histoData, uncertainty) {
