 ...
 * @class
 */
LiveQ.BufferReader = function( buffer ) {
 ...
 * @returns {int}
 */
LiveQ.BufferReader.prototype.getUint8 = function() {
 ...
 * @returns {Uint8Array}
 */
LiveQ.BufferReader.prototype.getUint8Array = function( length ) {
 ...
 * @returns {Uint16Array}
 */
LiveQ.BufferReader.prototype.getUint16Array = function( length ) {
 ...
 * @returns {Uint32Array}
 */
LiveQ.BufferReader.prototype.getUint32Array = function( length ) {
 ...
 */
LiveQ.BufferReader.prototype.getFloat32Array = function( length ) {
 ...
 */
LiveQ.BufferReader.prototype.getFloat64Array = function( length ) {
 ...
 * @returns {string}
 */
LiveQ.BufferReader.prototype.getString = function() {
 ...
 * @returns {string}
 */
LiveQ.BufferReader.prototype.getData = function(mime) {
